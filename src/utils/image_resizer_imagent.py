...
def parse_arguments():
    ...
    parser.add_argument('-i', '--in_dir', help="Input directory with source images", 
                        default="/cs/student/projects3/COMP0087/grp1/simclr_pytorch_new/datasets/iNat_kingdom/2021_train_mini")
    parser.add_argument('-o', '--out_dir', help="Output directory for resized images", 
                        default="/cs/student/projects3/COMP0087/grp1/simclr_pytorch_new/datasets/iNat64_2/")
